"""
Django settings for ComradeHousingHub project.
...
SECRET_KEY = 'django-insecure-e%0-l67^-$(+343t=&j2g(r7&8q980p4qh=^$k+h7(8z99vac+'
...
WSGI_APPLICATION = 'ComradeHousingHub.wsgi.application'
